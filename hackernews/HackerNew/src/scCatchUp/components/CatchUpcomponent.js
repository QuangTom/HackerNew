    ...
    render(){
      return(
        ...
        <View>
          ...
          <Text style = {styles.title2}>Last 24h</Text>
        </View>
        <TouchableOpacity  onPress={this._onPressHistoryButton} style = {styles.headerSearchButton}>
          <Icon name = 'history'  size = {22}/>
        </TouchableOpacity>
        <TouchableOpacity onPress= {this._onPressMoreButton} style = {[styles.headerMoreButton,{paddingRight: 10}]}>
