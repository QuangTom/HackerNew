...
class SavedStories extends Component{
    render(){
      return(
        ...
        <TouchableOpacity  onPress={this.onPressSearchButton} style = {styles.headerSearchButton}>
          <Icon name = 'search'  size = {22}/>
        </TouchableOpacity>
        <TouchableOpacity onPress= {this.onPressMoreButton} style = {[styles.headerMoreButton,{paddingRight: 10}]}>
